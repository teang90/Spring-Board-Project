    ...
    function html5Upload() {	
    	...
    	sUploadURL="/multipartPhotoUpload";
	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 			sUrl : '/multipartPhotoUpload',	// 스프링의 경우 에디터를 업로드할(글쓰기 처리할) 메소드 url
 			sCallback : '/resources/smarteditor2-2.8.2.3/sample/photo_uploader/callback.html', //sURL에서 처리한 다음 파일정보를 return해준 뒤 리턴값을 callback.html에서 처리
