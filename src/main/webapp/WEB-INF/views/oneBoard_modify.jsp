...
<body>
	...
	<h3 id="h3" style="text-align: center;">글 수정</h3>
	<hr>
		
	<form method="post" id="frm" class="container">
		...
		<div class="form-group row">
			...
			<input type="text" id="id" class="form-control" name="board_title" value="${board.board_title}" required >
		</div>
		
		<div class="form-group row">
			<label for="colFormLabel" class="col-form-label">내용</label>
			<textarea name="board_content" id="smartEditor" rows="10" cols="100" style="width:700px; height:500px;">${board.board_content}</textarea>
		</div>
		...
		<div class="form-group row"  style="text-align: center; margin-top: 50px;">
			<input type="button" class="btn btn-primary" id="savebutton" value="완료" onclick="goModify(this.form)" style="width: 200px;">
		</div>
